...
export default class MainEngineerScreen extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    console.log('datauserList', datauser)
    // firebase.database()
    //   .ref('dataRepair').on('value', (snapshot) => {
    ...
    firebase
      .database()
      .ref('dataRepair')
      .orderByChild('datauser/uid')
      .equalTo(datauser.uid)
        ...
        <View 
          ...
          <View style={{ justifyContent: 'flex-start', padding: 5, marginLeft: 40 }}>
            ...
            <Text
              ...
              {item.childData.status == 'wait' ? 
                                  <Text
                                  style={{
                                    color: '#000',
                                    fontSize: hp('1.8%'),
                                    fontFamily: 'sukhumvit-set-bold',
                                  }}>สถานะ : รอดำเนินการซ่อม</Text>
                                  :
                                  <Text
                                  style={{
                                    color: '#000',
